    ...
    return(
        <>
            <div className="flex sm:flex-col sm:gap-y-10 md:flex-row w-[100%] h-full justify-center pl-[15%] pr-[15%] pt-[3%] gap-x-5">
                <div className="relative space-y-16 sm:w-[100%] md:w-[30%] sm:h-[60px] md:h-auto flex flex-col sm:place-content-start md:place-content-center justify-start sm:overflow-x-auto ">
