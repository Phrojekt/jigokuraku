...
export function CharactersSelector({handleSetArray}: CharactersSelectorProps) {
    return ( 
        <div className="flex flex-row sm:flex-nowrap md:flex-wrap sm:gap-1 md:gap-0 md:gap-x-2 md:pt-[40px] md:pl-[20px] md:pt-[20px] md:overflow-hidden sm:w-[200%] h-full md:w-[100%]">
                        <div className="">
